    ...
    <div class="row justify-content-center mb-4">
      <div class="col-md-6">
        <form action="/posts" class="input-group mb-3">
          <button class="btn border-dark py-2 rounded-pill rounded-end bg-light border-end-0" type="submit" id="button-addon1"><i class="fa-solid fa-magnifying-glass"></i></button>
