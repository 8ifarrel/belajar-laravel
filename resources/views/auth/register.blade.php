            ...
            <main class="m-auto">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mt-2">
                        ...
                        <x-text-input id="username" class="block form-control border border-dark mt-2" type="text" name="username" :value="old('username')" required autofocus autocomplete="username" />
